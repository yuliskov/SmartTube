# Privacy Policy for SmartTube-mobil

**Last Updated:** March 21, 2026

This Privacy Policy applies specifically to **SmartTube-mobil** (Package ID: `org.smarttube.mobil`). This version is hardened for user privacy and compliance with F-Droid-style inclusion expectations.

## 1. Scope of this Policy
This document covers the **SmartTube-mobil build** only. Other versions or "flavors" of the application (e.g., Stable, Beta) may contain additional features such as self-update mechanisms or crash reporting that are removed in this release.

## 2. Data Collection and Processing
* **No Backend:** The SmartTube-mobil build operates entirely as a client-side application. It does not communicate with any developer-controlled servers.
...
* **No Update Tracking:** The self-update mechanism is disabled in this flavor. Updates are handled externally by the selected distribution channel.
...
## 8. Contact
For technical inquiries regarding the privacy architecture of the SmartTube-mobil build, please open an issue on the official GitHub repository.

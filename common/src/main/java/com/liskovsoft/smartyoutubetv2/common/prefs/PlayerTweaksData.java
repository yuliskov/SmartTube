...
public class PlayerTweaksData {
    ...
    private void restoreData() {
        ...
        mPlayerButtons = Helpers.parseInt(split, 13, Integer.MAX_VALUE & ~(PlayerTweaksData.PLAYER_BUTTON_SEEK_INTERVAL | PlayerTweaksData.PLAYER_BUTTON_PLAYBACK_QUEUE)); // all buttons, except seek interval

...
public class TrackSelectorUtilOld {
    ...
    private static String buildResolutionString(Format format) {
        return format.width == Format.NO_VALUE || format.height == Format.NO_VALUE ? "" : align(format.height + "p", 9);
    }

    private static String buildResolutionStringAlt(Format format) {

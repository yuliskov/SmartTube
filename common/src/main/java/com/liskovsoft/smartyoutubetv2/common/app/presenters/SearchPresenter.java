...
public class SearchPresenter extends BasePresenter<SearchView> implements VideoGroupPresenter {
    ...
    public void onViewInitialized() {
        ...
        getView().setTagsProvider(
                new MediaServiceSearchTagProvider(
                        getSearchData().isSearchHistoryDisabled()
                )
        );
    ...
    public void onTagLongClicked(Tag item) {
        ...
        AppDialogPresenter settingsPresenter =
                AppDialogPresenter.instance(getContext());
        ...
        settingsPresenter.showDialog(
                getContext().getString(R.string.settings_search)
        );
    }

    private void appendRemoveSearchTagButton(
            AppDialogPresenter settingsPresenter,
            Tag item
    ) {
        ...
        settingsPresenter.appendSingleButton(
                UiOptionItem.from(
                        getContext().getString(R.string.remove_from_search_history),
                        option -> {
                            MediaServiceManager.instance()
                                    .removeSearchTag(item.tag);
    ...
    private void appendClearSearchHistoryButton(
            AppDialogPresenter settingsPresenter
    ) {
    ...
    public boolean hasPendingActions() {
        return RxHelper.isAnyActionRunning(
                mLoadAction,
                mScrollAction
        );
    }
    ...
    public void onSearch(String searchText) {
        ...
        if (getView() == null) {
            ...
            Log.e(
                    TAG,
                    "Search view has been unloaded from the memory. Low RAM?"
            );
    ...
    private void loadSearchResult(String searchText) {
        ...
        mLoadAction =
                contentService.getSearchObserve(
                                searchText,
                                mUploadDateOptions
                                        | mDurationOptions
                                        | mTypeOptions
                        ...
                        .subscribe(
                                mediaGroups -> {
                                    ...
                                    for (MediaGroup mediaGroup : mediaGroups) {
                                        ...
                                        VideoGroup group =
                                                VideoGroup.from(mediaGroup);

                                        // SKIP EMPTY GROUPS
                                        if (group == null ||
                                                group.getVideos() == null ||
                                                group.getVideos().isEmpty()) {
                                            continue;
                                        }
    ...
    private void continueGroup(VideoGroup group) {
        ...
        Log.d(
                TAG,
                "continueGroup: start continue group: "
                        + group.getTitle()
        );
        ...
        mScrollAction =
                contentService.continueGroupObserve(mediaGroup)
                        .subscribe(
                                continueMediaGroup -> {
                                    ...
                                    // SKIP EMPTY GROUPS
                                    if (newGroup == null ||
                                            newGroup.getVideos() == null ||
                                            newGroup.getVideos().isEmpty()) {
    ...
    public void onScrollEnd(Video item) {
        ...
        Log.d(
                TAG,
                "onScrollEnd: Group title: " + group.getTitle()
        );
    ...
    private void startSearchInt() {
        ...
        if ((mIsVoice ||
                getSearchData().isInstantVoiceSearchEnabled())
                &&
                mSearchText == null) {
    ...
    private void appendFilterByDateCategory(
            AppDialogPresenter settingsPresenter
    ) {
        ...
        settingsPresenter.appendRadioCategory(
                getContext().getString(R.string.upload_date),
                options
        );
    }

    private void appendFilterByDurationCategory(
            AppDialogPresenter settingsPresenter
    ) {
        ...
        settingsPresenter.appendRadioCategory(
                getContext().getString(R.string.video_duration),
                options
        );
    }

    private void appendFilterByTypeCategory(
            AppDialogPresenter settingsPresenter
    ) {
        ...
        settingsPresenter.appendRadioCategory(
                getContext().getString(R.string.content_type),
                options
        );
    }

    private void appendFilterByFeatureCategory(
            AppDialogPresenter settingsPresenter
    ) {
        ...
        settingsPresenter.appendCheckedCategory(
                getContext().getString(R.string.video_features),
                options
        );
    }

    private void appendSortByCategory(
            AppDialogPresenter settingsPresenter
    ) {

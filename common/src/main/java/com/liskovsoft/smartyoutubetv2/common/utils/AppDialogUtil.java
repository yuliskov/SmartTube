...
public class AppDialogUtil {
    ...
    /**
     * Appends the full Nightlight settings block (warmth list + "Apply to UI" + "Apply during HDR")
     * to a dialog. Shared by the player button's long-press dialog and the General settings entry.
     * {@code onApply} runs after any option change so the caller can re-tint / refresh button state.
     */

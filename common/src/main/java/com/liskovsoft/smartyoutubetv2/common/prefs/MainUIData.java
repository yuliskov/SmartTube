...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            MENU_ITEM_EXIT_FROM_PIP, MENU_ITEM_PLAY_VIDEO, MENU_ITEM_PLAY_VIDEO_INCOGNITO, MENU_ITEM_PLAY_FROM_START, MENU_ITEM_START_MIX, MENU_ITEM_REMOVE_FROM_HISTORY,

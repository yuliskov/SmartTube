...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    private static final Long[] MENU_ITEM_DEFAULT_ORDER = {
            ...
            MENU_ITEM_STREAM_REMINDER, MENU_ITEM_NOT_INTERESTED, MENU_ITEM_NOT_RECOMMEND_CHANNEL, MENU_ITEM_REMOVE_FROM_SUBSCRIPTIONS,
            MENU_ITEM_RECENT_PLAYLIST, MENU_ITEM_ADD_TO_PLAYLIST, MENU_ITEM_CREATE_PLAYLIST, MENU_ITEM_RENAME_PLAYLIST, MENU_ITEM_ADD_TO_NEW_PLAYLIST,

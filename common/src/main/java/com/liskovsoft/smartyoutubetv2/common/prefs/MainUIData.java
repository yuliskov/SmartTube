...
public class MainUIData extends DataChangeBase implements ProfileChangeListener {
    ...
    public static final long MENU_ITEM_SHUFFLE_PLAYLIST = 1L << 39;
    public static final long MENU_ITEM_SHUFFLE_CHANNEL = 1L << 40;
    ...
    public static final long MENU_ITEM_DEFAULT = MENU_ITEM_PIN_TO_SIDEBAR | MENU_ITEM_NOT_INTERESTED | MENU_ITEM_NOT_RECOMMEND_CHANNEL
            ...
            | MENU_ITEM_SUBSCRIBE | MENU_ITEM_CLEAR_HISTORY | MENU_ITEM_ADD_TO_WATCH_LATER | MENU_ITEM_SHUFFLE_PLAYLIST
            | MENU_ITEM_SHUFFLE_CHANNEL;

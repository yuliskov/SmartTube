...
import com.liskovsoft.smartyoutubetv2.tv.ui.playback.settings.VideoSettingsActivity;
...
public class MainApplication extends MultiDexApplication { // fix: Didn't find class "com.google.firebase.provider.FirebaseInitProvider"
    ...
    public void onCreate() {
        ...
        viewManager.register(VideoSettingsView.class, VideoSettingsActivity.class, PlaybackActivity.class);

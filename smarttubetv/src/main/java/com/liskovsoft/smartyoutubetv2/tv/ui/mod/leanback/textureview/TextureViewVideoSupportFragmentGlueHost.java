 ...
 */
public class TextureViewVideoSupportFragmentGlueHost extends PlaybackSupportFragmentGlueHost
    ...
    private final TextureViewVideoSupportFragment mFragment;

    public TextureViewVideoSupportFragmentGlueHost(TextureViewVideoSupportFragment fragment) {
        super(fragment);

...
public class HeaderTextGridFragment extends GridFragment implements SettingsFragment {
    private static final String TAG = HeaderTextGridFragment.class.getSimpleName();
